...
export const adminOwnProfileQueryKey = ['admin-own-profile'] as const
...
export const useAdminOwnProfile = () => {
  ...
  const profileQuery = useQuery({
    queryKey: computed(() => [...adminOwnProfileQueryKey, userId.value]),
  ...
  const updateEmailMutation = useMutation({
    ...
    onSuccess: (response) => {
      queryClient.setQueryData(
        [...adminOwnProfileQueryKey, userId.value],
